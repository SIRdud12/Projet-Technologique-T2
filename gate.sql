...
INSERT INTO Utilisateur (Email, MDP, Nom, Prenom, roles, Statu) VALUES
('alice@example.com', 'password123', 'Alice', 'Smith', 'Admin', 'Admin'),
('bob@example.com', 'password456', 'Bob', 'Brown', 'User', 'accepter'),
('charlie@example.com', 'password789', 'Charlie', 'Davis', 'User', 'en attente');
