...
INSERT INTO Utilisateur (Email, MDP, Nom, Prenom,photo, Statu) VALUES
('alice@example.com', 'password123', 'Alice', 'Smith', 'img.jpg', 'Admin'),
('bob@example.com', 'password456', 'Bob', 'Brown', 'test.jpg', 'accepter'),
('charlie@example.com', 'password789', 'Charlie', 'Davis', 'test.jpg', 'en attente');
